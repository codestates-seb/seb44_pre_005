package com.pre.preproject.auth.handler;
...
public class OAuth2MemberSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public OAuth2MemberSuccessHandler (JwtTokenizer jwtTokenizer, CustomAuthorityUtils authorityUtils, MemberService memberService, RefreshTokenService refreshTokenService){
    ...
    private URI createURI(String accessToken, String refreshToken) {
        ...
        return UriComponentsBuilder
                .newInstance()
                .scheme("http")
                .host("ec2-43-200-88-48.ap-northeast-2.compute.amazonaws.com")
                .port(3000)
                .path("/")
